...
- **Topic 1: Plan:** Use Plan Mode to create a better strategy before coding. Review and finalize a high-level plan, and start implementation only after approval. Eg: to include html & css for displaying of clocks.
